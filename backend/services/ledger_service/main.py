...
"""Ledger Service - Double-Entry Accounting & Financial Records."""
...
app = FastAPI(
    title="Wings of Capital - Ledger Service",
    description="Double-entry accounting & financial records microservice",
    version="1.0.0",
    docs_url="/docs",
